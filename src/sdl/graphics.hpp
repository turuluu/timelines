...
void render_text_v(font* font, color color, rect text_bounds, const char* text, int ptsize = 40);

void render_text_h(font* font, color color, rect text_bounds, const char* text, int ptsize = 40);
