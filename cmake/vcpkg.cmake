if (NOT CMAKE_TOOLCHAIN_FILE)
    if (NOT EXISTS ${vcpkg_cmake_script})
        find_package(Git)
        if (Git_FOUND)
            message(STATUS "Cloning vcpkg to ${local_vcpkg}..")
            # shallow-clone vcpkg (we only need the latest revision)
            execute_process(COMMAND ${GIT_EXECUTABLE} submodule update --depth=1 --init --recursive ${local_vcpkg}
    ...
    set(CMAKE_TOOLCHAIN_FILE ${vcpkg_cmake_script})
endif ()
